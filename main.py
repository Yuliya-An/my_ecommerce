...
if __name__ == "__main__":
    # Ручное создание товаров и категорий для тестирования
    ...
    print(f"Загружено {len(categories)} категорий из файла.")
    total_products = sum(len(cat.products) for cat in categories)
    print(f"Загружено {total_products} продуктов из файла.")
